...
var defaultTemplate = 'studylistStudy';
Template.lesionTrackerStudyListStudy.replaces(defaultTemplate);

// Add the TimepointName helper to the default template. The
// HTML of this template is replaced with that of lesionTrackerStudyListStudy
...
// Observe changes on StudyListTabs
// remove the current user from Reviewers if tab is removed
StudyListTabs.find().observe({
